...
#ifndef YY_YY_B3DPARSERFX_H_INCLUDED
# define YY_YY_B3DPARSERFX_H_INCLUDED
/* Enabling traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     TOKEN_CULLMODE = 290,
     TOKEN_DEPTHBIAS = 291,
     TOKEN_SDEPTHBIAS = 292,
     TOKEN_DEPTHCLIP = 293,
     TOKEN_SCISSOR = 294,
     TOKEN_MULTISAMPLE = 295,
     TOKEN_AALINE = 296,
     TOKEN_DEPTHREAD = 297,
     TOKEN_DEPTHWRITE = 298,
     TOKEN_COMPAREFUNC = 299,
     TOKEN_STENCILREF = 300,
     TOKEN_ENABLED = 301,
     TOKEN_READMASK = 302,
     TOKEN_WRITEMASK = 303,
     TOKEN_STENCILOPFRONT = 304,
     TOKEN_STENCILOPBACK = 305,
     TOKEN_FAIL = 306,
     TOKEN_ZFAIL = 307,
     TOKEN_ALPHATOCOVERAGE = 308,
     TOKEN_INDEPENDANTBLEND = 309,
     TOKEN_TARGET = 310,
     TOKEN_INDEX = 311,
     TOKEN_COLOR = 312,
     TOKEN_ALPHA = 313,
...
#endif /* !YY_YY_B3DPARSERFX_H_INCLUDED  */
