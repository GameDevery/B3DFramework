...
namespace b3d
{
	namespace render
	{
		...
		/** Submission-boundary state shared by buffer and image transitions. */
		struct B3D_EXPORT GpuSubmissionTransition
		{
			...
			GpuHazardState::TransitionRecipe SameQueueTransitionRecipe; /**< Barrier recorded on the destination queue, if needed. */
